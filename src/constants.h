...
const char POLLEN_API_SWITZERLAND[] = "https://www.pollenundallergie.ch/modul/echtzeitdaten/templates/"
                                      "index.cfm?action=messstation&location=%1&prognoseDatum=%2";
...
const char NETWORK_REPLY_PROPERTY_REQUEST_DAY[] = "requestDay";
